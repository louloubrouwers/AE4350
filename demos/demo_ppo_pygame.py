...
CUSTOM_PPO_DIR = ROOT / "custom_ppo"
if str(CUSTOM_PPO_DIR) not in sys.path:
    sys.path.insert(0, str(CUSTOM_PPO_DIR))

from custom_ppo_agent import PPOAgent  # noqa: E402
from scripts.train_ppo import RunningNormalizer  # noqa: E402
...
def main():
    ...
    args.algorithm_label = "Custom PPO"
    ...
    def policy_fn(obs):
        ...
        return agent.deterministic_action(obs_in)

    run_pygame_loop(args, env, policy_fn, title="Custom PPO Drone Navigation Demo", show_wind=False)
