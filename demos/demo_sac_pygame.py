...
def main():
    parser = base_parser(default_task="three_obstacles_random", default_model_name="best_model")
    args = parser.parse_args()
    args.algorithm_label = "SAC"
    ...
    run_pygame_loop(args, env, policy_fn, title="SAC Drone Navigation Demo", show_wind=True)
